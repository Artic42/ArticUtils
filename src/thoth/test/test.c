...
int main (void)
{
    ...
    struct log* log1 = createLog ("Log1", "src/thoth/test/logs", INFO, 3);
    struct log* log2 = createLog ("Log2", "src/thoth/test/logs", DEBUG, 3);
    struct log* log3 = createLog ("Log3", "src/thoth/test/logs", INFO | DEBUG, 3);
